...
int main()
{
    try
    {
        ...
        */
        strcpy(szBuffer, "From: Mini Dawar <sip:v9059440262@vbuzzer.com>;tag=1ffe87b1cb7ddc73o0");
        strcpy(szBuffer, "f: Mini Dawar <sip:v9059440262@vbuzzer.com>;tag=1ffe87b1cb7ddc73o0");
        strcpy(szBuffer, "t: Mini Dawar <sip:v9059440262@vbuzzer.com>;tag=1ffe87b1cb7ddc73o0");
        // 
        CSipHeader objSipHeader(512), objSipHeader1(512);
        // 
        strcpy(szBuffer, "From: Mini Dawar <sip:v9059440262@vbuzzer.com>;tag=1ffe87b1cb7ddc73o0");
        objSipHeader.SetBuffer(szBuffer);
        // 
        strcpy(szBuffer, "f: Mini Dawar <sip:v9059440262@vbuzzer.com>;tag=1ffe87b1cb7ddc73o0");
        objSipHeader1.SetBuffer(szBuffer);        
        // 
        objSipHeader.Parse();
        objSipHeader1.Parse();
        // 
        objSipHeader.PrintStructure();
        objSipHeader1.PrintStructure();
        // 
        if(objSipHeader.IsNameMatch(objSipHeader1)) 
        {
            printf("Matches!\n");
        }
        // == 
        if(objSipHeader == objSipHeader1)
        {
            printf("0 == 1\n");
        }
